...
function GameQuestion({name, }){
    ...
    <div>
        ...
        <Grid item xs={6}>
          <Paper className={classes.paper}>
          <center>
            <Avatar alt="Remy Sharp" src= {person2} className={classes.large} />
            </center>
          </Paper>
        </Grid>
        <Grid item xs={6}>
          <Paper className={classes.paper}>
          <center>
            <Avatar alt="Remy Sharp" src= {person3} className={classes.large} />
            </center>
          </Paper>
        </Grid>
        <Grid item xs={6}>
          <Paper className={classes.paper}>
          <center>
            <Avatar alt="Remy Sharp" src= {person4} className={classes.large} />
            </center>
          </Paper>
        </Grid>
      </Grid>
